...
def main() -> int:
    ...
    p.add_argument("--vlm", type=str, default="frontier_claude")
    ...
    package_ablation(
        ablation_id=args.ablation, runs_path=args.runs,
        zip_output_path=args.out, vlm_alias=args.vlm,
        prompt_style=args.prompt_style, repo_dir=args.repo_dir,
