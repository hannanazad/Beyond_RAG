    ...
    def flush() -> None:
        ...
        if section_started and cur_rule and cur_ord is not None and cur_body:
            ...
            if text:
                ...
                # a page break re-fires the ordinal, so 36 ids collided across
                # 107 rows and silently overwrote each other on upsert.
                # Suffix only the 2nd+ occurrence so existing ids stay stable.
